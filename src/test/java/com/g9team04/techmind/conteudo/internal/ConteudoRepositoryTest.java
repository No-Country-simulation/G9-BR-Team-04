...
class ConteudoRepositoryTest {
    ...
    void deveEncontrarPorTituloContendoIgnorandoCase() {
        repository.save(new ConteudoEntity("Introdução ao Spring Boot", "Texto 1"));
        repository.save(new ConteudoEntity("Outro assunto qualquer", "Texto 2"));
    ...
    void deveEncontrarPorCategoriaExcluindoIdEspecifico() {
        ...
        var salvo1 = repository.save(entity1);
        repository.save(entity2);
