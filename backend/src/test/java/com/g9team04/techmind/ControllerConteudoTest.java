...
public class ControllerConteudoTest {
    ...
    void devePostarConteudoComSucesso() throws Exception {
        ...
        var response = new ConteudoResponse(1L, "Introdução ao Spring Boot", "texto de teste", "Backend", 0.95, List.of("Java", "Spring Boot"), java.time.LocalDateTime.now());
    ...
    void deveBuscarPorCategoriaComSucesso() throws Exception {
        var response = new ConteudoResponse(1L, "titulo", "texto de teste", "Backend", 0.9, List.of(), java.time.LocalDateTime.now());
